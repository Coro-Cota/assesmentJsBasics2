...
let canWeDeliverTwo = (zipCode) => {
    for (let i = 0; i < deliveryAreaZipCodes.length; i++) {
        const zip_code = deliveryAreaZipCodes[i];
        if (zip_code === zipCode){
            return `You're in our delivery zone!`
        }
    }
...
//CODE HERE
let titleReplace = deals[0]
titleReplace["title"] = `10% Off!`
...
let descReplace = deals[1]
descReplace["desc"] = '   This deal lasts until the end of April! '